...
v, err = integrate.quad(rectangl, 1.2, 2)
...
print("middle rectangle method = ", rt_fun(rectangl, 1.2, 2, 10))
print("left rectangle method = ", rtleft_fun(rectangl, 1.2, 2, 10))
print("right rectangle method = ", rtright_fun(rectangl, 1.2, 2, 10))

print('Check for the rectangle method = ', v)


def trapezoid(x):
    return x / (sqrt(2 * x ** 2 + 3))
...
v, err = integrate.quad(trapezoid, 0.8, 1.4)
print("Trapezoid method = ", tr_fun(trapezoid, 0.8, 1.4, 20))
print('Check for trapezoid method = ', v)


def simpson(x):
    return (sqrt(x) + 1) * math.tan(2 * x)
...
print("Simpson method= ", sp_fun(simpson, 0.6, 0.72, 8))
v, err = integrate.quad(simpson, 0.6, 0.72)
